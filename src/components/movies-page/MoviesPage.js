            ...
            <DarkThemeContext.Consumer>
                {
                    (data) => {
                        return (
                            <div className={`movies-list ${data.isDarkTheme && !isMoviesLoading && 'dark'}`}>
                                <div>
                                    <h2 className={`movies-list-title ${data.isDarkTheme && !isMoviesLoading && 'dark'}`}>Movies List</h2>
                                    {
                                        <div>
                                            <SelectMoviesSort
                                ...
                                <div>
                                     {
                                         !isMoviesLoading && btnPaginationNames.map(item => {
                                            return (
                                                <BtnPagination
                                                    url={url}
                                                    className={`btn-pagination btn btn-outline-primary ${item === page && 'active'}`}
                                                    value={item}
                                                    key={item}
                                                />
                                            );
